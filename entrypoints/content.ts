...
import { initLanguageDetector, detectLanguage } from '../components/utils/language-detector.js';
import { isDifficultyCompatible, isCodeText, isNonLearningWord } from '../components/utils/word-filters.js';
import { isInAllowedContentEditableRegion } from '../components/utils/dom-utils.js';
import { applyThemeVariables } from '../components/utils/color-utils.js';
import { TooltipManager } from '../components/ui/tooltip.js';
import { showToast } from '../components/ui/toast.js';
import { apiService } from '../components/services/api-service.js';
import { contentSegmenter } from '../components/services/content-segmenter.js';
...
async function init() {
  ...
  try {
    await loadConfig();
    console.log('[Sapling] loadConfig() completed', config);
  } catch (e) {
