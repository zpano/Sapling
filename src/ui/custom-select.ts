...
export function initCustomSelects(
  selectElements: HTMLSelectElement | HTMLSelectElement[] | NodeListOf<HTMLSelectElement> | null | undefined,
  { onOpen }: CustomSelectOptions = {}
) {
  ...
  const normalized = Array.isArray(selectElements)
    ? selectElements
    : selectElements && typeof (selectElements as NodeListOf<HTMLSelectElement>).length === 'number'
      ? Array.from(selectElements as NodeListOf<HTMLSelectElement>)
      : selectElements
        ? [selectElements]
        : [];
