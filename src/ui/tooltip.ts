...
import { getDictionaryEntry, playDictionaryAudio } from '~/ui/wiktionary';
import { playGoogleTranslateTts, playYoudaoDictVoice } from '~/ui/pronunciation';
...
type TooltipConfig = Pick<SaplingConfig, 'targetLanguage' | 'pronunciationProvider' | 'youdaoPronunciationType'>;
...
export class TooltipManager {
  ...
  private tooltipHideTimeout: ReturnType<typeof setTimeout> | null;
  private config: TooltipConfig | null;
   ...
   */
  positionTooltip(targetRect: DOMRect) {
