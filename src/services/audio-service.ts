...
import type { FetchAudioDataRequest, FetchAudioDataResponse } from '~/types/messages';
...
export async function playAudioUrl(url) {
  ...
  try {
    ...
    const result = await chrome.runtime.sendMessage(
      { action: 'fetchAudioData', url } satisfies FetchAudioDataRequest
    ) as FetchAudioDataResponse;
